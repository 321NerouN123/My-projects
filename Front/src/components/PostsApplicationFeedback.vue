<template>
    ...
    <div class="content">
        <div class="topside-bar">
            <div class="caption">
                <b>Обратная связь по приложению</b>
                <p>Данный раздел повсящен обсуждению различных приложений и игр. Приветствуется конструктивная критика</p>
            </div>
            <div class="butt">
                <!--<button onclick="document.location='#/CreatePost'"><a href="#/CreatePost">Создать пост</a></button>-->
                <router-link :to="{ name: 'CreatePost', params: { topicId: 20 } }">
