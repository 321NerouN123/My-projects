<template>
    ...
    <div class="content">
        <div class="topside-bar">
            <div class="caption">
                <b>Интерактивы и конкурсы</b>
                <p>Данный раздел повсящен проведению различных конкурсов и интерактивов форума</p>
            </div>
            <div class="butt">
                <!--<button onclick="document.location='#/CreatePost'"><a href="#/CreatePost">Создать пост</a></button>-->
                <router-link :to="{ name: 'CreatePost', params: { topicId: 19 } }">
